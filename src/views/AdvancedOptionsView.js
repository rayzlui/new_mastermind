...
export function AdvancedOptionsView(props){
  ...
  let gameTypeInputs = gameType === CLASSIC_MODE?
  <>
    ...
    <button onClick={() => vsComputer([codeLength, optionsLength, turnsLength, timeAllowed])}>Play Versus Computer</button>
    <button onClick={() => vsPlayer([codeLength, optionsLength, turnsLength,timeAllowed])}>Play Versus Player</button>
  </>
  :
  <>
    ...
    <button onClick={() => vsComputer([codeLength, optionsLength, turnsLength, timeAllowed])}>Play</button>
  </>
  return(
    <>
